...
async function handleEvent(event) {
  ...
  if(text==="crrt_mode_info"){await client.replyMessage(replyToken,{type:"flex",altText:"📋 CRRT Mode",contents:{type:"bubble",hero:{type:"box",layout:"horizontal",backgroundColor:"#0D47A1",paddingAll:"14px",spacing:"sm",contents:[{type:"image",url:LOGO_URL,size:"xxs",flex:0,aspectMode:"fit",aspectRatio:"124:100"},{type:"box",layout:"vertical",flex:1,justifyContent:"center",contents:[{type:"text",text:"RA5IC · RAMATHIBODI",color:"rgba(255,255,255,0.75)",size:"xxs"},{type:"text",text:"📋 CRRT Mode — รูปแบบการฟอกไต",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true}]}]},body:{type:"box",layout:"vertical",paddingAll:"14px",backgroundColor:"#F0F6FF",spacing:"sm",contents:[{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E3F2FD",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#0D47A1",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"📋 CRRT 4 Mode หลัก",weight:"bold",size:"sm",color:"#0D47A1",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#0D47A1",size:"sm",flex:0,gravity:"top"},{type:"text",text:"SCUF: ดึงน้ำส่วนเกินอย่างเดียว (UF only) ✅ CHF/Volume overload",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#0D47A1",size:"sm",flex:0,gravity:"top"},{type:"text",text:"CVVH: Convection — กำจัดโมเลกุลกลาง-ใหญ่ ✅ Rhabdomyolysis/Citrate",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#0D47A1",size:"sm",flex:0,gravity:"top"},{type:"text",text:"CVVHD: Diffusion — ล้างโมเลกุลเล็ก (Urea,K+) ✅ KRT primary/maintenance",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#0D47A1",size:"sm",flex:0,gravity:"top"},{type:"text",text:"CVVHDF: Convection+Diffusion ✅ RA5IC ใช้ Mode นี้ — Most common",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFF3E0",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#E65100",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"⚙️ Prescription RA5IC (Adisorn MD)",weight:"bold",size:"sm",color:"#BF360C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Machine: Prismaflex/Infomed HF440 | BFR: 100-150 ml/min",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Dose: 30 ml/kg/hr | BW60kg=1,800 ml/hr | Dialysate 1,200+Pre 300+Post 300",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Replacement: Accusol 5,000ml+KCl 15mEq | NSS flush 200ml ทุก 8ชม.",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E8F5E9",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#2E7D32",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"📊 Dose (KDIGO 2012 Grade 1A)",weight:"bold",size:"sm",color:"#1B5E20",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Normal: Prescribed 25-30 → Delivered 20-25 ml/kg/h",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"High: Prescribed 40 → Delivered 35 ml/kg/h (Hypercatabolic)",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Delivered ≈ 80% ของ Prescribed (Circuit downtime ~20%)",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFEBEE",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#C62828",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"⚠️ Quality Benchmark",weight:"bold",size:"sm",color:"#B71C1C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Filter life>60ชม. ≥60% | Delivered≥80% | Downtime≤10%/วัน",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Monitor K,Na,Ca,Mg,PO4 ทุก 6-8ชม. | CLABSI=0 events",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"message",label:"📚 กลับ Knowledge",text:"crrt_knowledge"},style:"primary",color:"#1565C0",height:"sm",adjustMode:"shrink-to-fit"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}

  if(text==="crrt_pressure_info"){await client.replyMessage(replyToken,{type:"flex",altText:"📊 Pressure CRRT",contents:{type:"bubble",hero:{type:"box",layout:"horizontal",backgroundColor:"#880E4F",paddingAll:"14px",spacing:"sm",contents:[{type:"image",url:LOGO_URL,size:"xxs",flex:0,aspectMode:"fit",aspectRatio:"124:100"},{type:"box",layout:"vertical",flex:1,justifyContent:"center",contents:[{type:"text",text:"RA5IC · RAMATHIBODI",color:"rgba(255,255,255,0.75)",size:"xxs"},{type:"text",text:"📊 ค่า Pressure — Prismaflex",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true}]}]},body:{type:"box",layout:"vertical",paddingAll:"14px",backgroundColor:"#FFF5FA",spacing:"sm",contents:[{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FCE4EC",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#880E4F",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"📊 ค่า Pressure 5 จุด",weight:"bold",size:"sm",color:"#880E4F",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#880E4F",size:"sm",flex:0,gravity:"top"},{type:"text",text:"🔴 Access (AP): -50 ถึง -150 | >-150 → DLC ชิดผนัง/สายพับ/BFR สูง",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#880E4F",size:"sm",flex:0,gravity:"top"},{type:"text",text:"🔵 Venous (VP): +50 ถึง +150 | >+150 → Clot ใน Return/Chamber",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#880E4F",size:"sm",flex:0,gravity:"top"},{type:"text",text:"🟠 Filter (FP): +100 ถึง +250 | >+250 → Risk Clotting",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#880E4F",size:"sm",flex:0,gravity:"top"},{type:"text",text:"🟡 TMP: (FP+VP)÷2−EP | >+200 Risk | ขึ้นช้า=Clogging ขึ้นเร็ว=Clot",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#880E4F",size:"sm",flex:0,gravity:"top"},{type:"text",text:"⚫ Effluent (EP): -150 ถึง +50 | <-150 → Membrane อุดตัน",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E3F2FD",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#1565C0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"🔍 วิเคราะห์ Pattern",weight:"bold",size:"sm",color:"#0D47A1",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Access ปัญหา: AP>-150 เท่านั้น | VP/FP/TMP ปกติ",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Filter Clotting: FP>+250, ΔP+100+ | TMP ขึ้นเร็ว",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Filter Clogging: EP<-150, ΔP+150+ | TMP ขึ้นช้าๆ",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E8F5E9",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#2E7D32",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"✅ แก้ TMP สูง",weight:"bold",size:"sm",color:"#1B5E20",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"TMP ขึ้นช้า: ลด Post-dilution → เพิ่ม Pre-dilution",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"TMP ขึ้นเร็ว: ตรวจ Effluent bag ตัน → Unclamp/เปลี่ยนถุง",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"ทบทวน Anticoagulation | เพิ่ม BFR(≤200) | ตรวจ Pressure dome",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFEBEE",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#C62828",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"⚠️ ต้องคืนเลือดเมื่อ",weight:"bold",size:"sm",color:"#B71C1C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"FP>+250+TMP สูงต่อเนื่อง | Filter ดำสนิท → แจ้งแพทย์ทันที",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"message",label:"📚 กลับ Knowledge",text:"crrt_knowledge"},style:"primary",color:"#1565C0",height:"sm",adjustMode:"shrink-to-fit"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}

  if(text==="crrt_billing"){await client.replyMessage(replyToken,{type:"flex",altText:"💳 สิทธิ์การรักษา",contents:{type:"bubble",hero:{type:"box",layout:"horizontal",backgroundColor:"#1565C0",paddingAll:"14px",spacing:"sm",contents:[{type:"image",url:LOGO_URL,size:"xxs",flex:0,aspectMode:"fit",aspectRatio:"124:100"},{type:"box",layout:"vertical",flex:1,justifyContent:"center",contents:[{type:"text",text:"RA5IC · RAMATHIBODI",color:"rgba(255,255,255,0.75)",size:"xxs"},{type:"text",text:"💳 สิทธิ์การรักษา CRRT — 2569",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true}]}]},body:{type:"box",layout:"vertical",paddingAll:"14px",backgroundColor:"#F0F4FF",spacing:"sm",contents:[{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFEBEE",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#C62828",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"⚠️ หมายเหตุสำคัญ",weight:"bold",size:"sm",color:"#B71C1C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"อนุมัติเฉพาะ AKI เท่านั้น | ESKD → MKC6 ทุกสิทธิ์ (ร่วมจ่ายเสมอ)",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Oxiris (ตัวกรอง Cytokine) — ไม่มีเหมารวม ร่วมจ่ายทุกกรณี",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E3F2FD",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#1565C0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"💛 เงินสด / รัฐวิสาหกิจ",weight:"bold",size:"sm",color:"#0D47A1",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"MKC6 ทุกวัน | ซื้อตามจริง ไม่มีเหมารวม | ร่วมจ่าย",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"MKC6=8,000 + Filter+Circuit=6,000 + Replace=10,000 + Drain=250 บาท",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#EDE7F6",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#5E35B1",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"💜 ประกันสุขภาพ / ประกันสังคม",weight:"bold",size:"sm",color:"#4527A0",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#5E35B1",size:"sm",flex:0,gravity:"top"},{type:"text",text:"วันแรก: M313 — เหมารวมทุกรายการ ไม่ต้องร่วมจ่าย",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#5E35B1",size:"sm",flex:0,gravity:"top"},{type:"text",text:"วัน 2+: M314 — เหมารวมทุกรายการ ไม่ต้องร่วมจ่าย",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E3F2FD",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#1565C0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"💙 ข้าราชการ / อปท. / กทม.",weight:"bold",size:"sm",color:"#0D47A1",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"วันแรก: M313 | วัน 2-5: M314 — เหมารวม ไม่ร่วมจ่าย",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"วันที่ 6+: MKC6 — ซื้อตามจริง ร่วมจ่าย",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E8F5E9",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#2E7D32",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"📊 สรุปรหัส",weight:"bold",size:"sm",color:"#1B5E20",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"M313=วันแรก | M314=วันต่อไป | MKC6=เงินสด/วัน6+/ESKD",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"RCA (Citrate) รวมใน CRRT ทุกสิทธิ์ | บันทึก Indication AKI+Shock",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"message",label:"📚 กลับ Knowledge",text:"crrt_knowledge"},style:"primary",color:"#1565C0",height:"sm",adjustMode:"shrink-to-fit"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}

  if(text==="crrt_supplies"){await client.replyMessage(replyToken,{type:"flex",altText:"📦 Solution CRRT",contents:{type:"bubble",hero:{type:"box",layout:"horizontal",backgroundColor:"#4527A0",paddingAll:"14px",spacing:"sm",contents:[{type:"image",url:LOGO_URL,size:"xxs",flex:0,aspectMode:"fit",aspectRatio:"124:100"},{type:"box",layout:"vertical",flex:1,justifyContent:"center",contents:[{type:"text",text:"RA5IC · RAMATHIBODI",color:"rgba(255,255,255,0.75)",size:"xxs"},{type:"text",text:"📦 CRRT Solution & อุปกรณ์",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true}]}]},body:{type:"box",layout:"vertical",paddingAll:"14px",backgroundColor:"#F5F0FF",spacing:"sm",contents:[{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#EDE7F6",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#4527A0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"🔧 CRRT Machine & Filter (Ramathibodi)",weight:"bold",size:"sm",color:"#4A148C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Prismaflex/Prismax: CVVHDF,SCUF,TPE,ECMO ✅ ใช้หลัก",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Filter: M100(30056375) Adult ✅ | Oxiris(30055135) Cytokine (เบิกไม่ได้)",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E8F5E9",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#2E7D32",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"💧 Ca-containing Solution",weight:"bold",size:"sm",color:"#1B5E20",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Accusol-35: Na140 Ca1.75 Mg0.5 HCO3-35 Glucose5.55 ✅ Standard RA5IC",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"MultiPlus K2: Na140 K2 Ca1.5 HCO3-35 Phos1 ✅ มี Phosphate",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Phoxilium: Na140 K2 Ca2.5 HCO3-32 Phos1",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFF3E0",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#E65100",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"🔬 Ca-free (ใช้กับ Citrate)",weight:"bold",size:"sm",color:"#BF360C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Prismasol B0: Na143 HCO3-35 ไม่มี Ca",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Ci-Ca K2: Na133 K2 HCO3-20 ✅ ใช้บ่อยกับ Citrate",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E3F2FD",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#1565C0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"📋 เลือก Dialysate K+",weight:"bold",size:"sm",color:"#0D47A1",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"K<4.5→K4 | K4.5-5.5→K3 | K>5.5→K2 | K>8.0→Acute HD",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"⚠️ ห้ามใช้ Zero K+ นาน → เสี่ยง Arrhythmia",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFEBEE",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#C62828",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"⚠️ ข้อควรระวัง",weight:"bold",size:"sm",color:"#B71C1C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Bicarbonate ตกตะกอนเมื่อผสมกับ Ca/Mg — ห้ามผสมในถุงเดียว",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"อุ่น Replacement fluid ก่อนใช้ | บันทึก Lot+วันหมดอายุ",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"message",label:"📚 กลับ Knowledge",text:"crrt_knowledge"},style:"primary",color:"#1565C0",height:"sm",adjustMode:"shrink-to-fit"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}

  if(text==="crrt_wound"){await client.replyMessage(replyToken,{type:"flex",altText:"🩹 ทำแผล DLC",contents:{type:"bubble",hero:{type:"box",layout:"horizontal",backgroundColor:"#C62828",paddingAll:"14px",spacing:"sm",contents:[{type:"image",url:LOGO_URL,size:"xxs",flex:0,aspectMode:"fit",aspectRatio:"124:100"},{type:"box",layout:"vertical",flex:1,justifyContent:"center",contents:[{type:"text",text:"RA5IC · RAMATHIBODI",color:"rgba(255,255,255,0.75)",size:"xxs"},{type:"text",text:"🩹 การทำแผล DLC — Aseptic",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true}]}]},body:{type:"box",layout:"vertical",paddingAll:"14px",backgroundColor:"#FFF0F0",spacing:"sm",contents:[{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFEBEE",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#C62828",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"📍 ตำแหน่ง DLC (KDIGO 2012)",weight:"bold",size:"sm",color:"#B71C1C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"1️⃣ Right IJV ✅: ยาว 12-15cm ขนาด 11-14.5Fr Tip ที่ lower 1/3 SVC",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"2️⃣ Femoral: ยาว 19-24cm | ⚠️ NCC ไม่ควรคาไว้>5วัน",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"3️⃣ Left IJV: ยาว 15-20cm | 4️⃣ Subclavian: Last choice เท่านั้น",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"✅ Ultrasound guide ทุกครั้ง (1A) | CXR ก่อน Start (1B)",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E3F2FD",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#1565C0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"🚀 ขั้นตอน Pre CRRT",weight:"bold",size:"sm",color:"#0D47A1",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"1️⃣ ล้างมือ+Sterile Glove+Mask | 2️⃣ เปิด Dressing เก่า ประเมิน Exit Site",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"3️⃣ เช็ด 2%CHG in 70%Alcohol รอบ Catheter | 4️⃣ Paint Exit Site",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"5️⃣ Scrub hub>5วิ | 6️⃣ Draw Heparin lock ทิ้ง 2x Prime volume",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"7️⃣ Test flow: ดูดเลือดออก+ฉีด NSS ไหลดี",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#EDE7F6",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#4527A0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"🔒 Lock Post CRRT",weight:"bold",size:"sm",color:"#4A148C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Flush NSS 10ml/ข้าง Push-pause | Lock Heparin 2,500U/ml เท่า Prime volume",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"✅ Positive pressure technique | Scrub hub>5วิ → ปิด Cap",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"⚠️ งด Lock heparin ถ้ามี Plan Off Catheter",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E8F5E9",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#2E7D32",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"📅 ความถี่",weight:"bold",size:"sm",color:"#1B5E20",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#2E7D32",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Transparent: ทุก 7วัน | Gauze: ทุก 2วัน | เปียก/สกปรก → เปลี่ยนทันที",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFEBEE",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#C62828",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"⚠️ ข้อห้าม",weight:"bold",size:"sm",color:"#B71C1C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"ห้ามใช้ Povidone-Iodine กับ DLC (ทำลาย Polyurethane)",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Exit Site แดง/หนอง → แจ้งแพทย์ทันที | สายหลุด → กดแน่น แจ้งแพทย์",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"message",label:"📚 กลับ Knowledge",text:"crrt_knowledge"},style:"primary",color:"#1565C0",height:"sm",adjustMode:"shrink-to-fit"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}

  if(text==="crrt_calc"){await client.replyMessage(replyToken,{type:"flex",altText:"🧮 คำนวณสารน้ำ",contents:{type:"bubble",hero:{type:"box",layout:"horizontal",backgroundColor:"#E65100",paddingAll:"14px",spacing:"sm",contents:[{type:"image",url:LOGO_URL,size:"xxs",flex:0,aspectMode:"fit",aspectRatio:"124:100"},{type:"box",layout:"vertical",flex:1,justifyContent:"center",contents:[{type:"text",text:"RA5IC · RAMATHIBODI",color:"rgba(255,255,255,0.75)",size:"xxs"},{type:"text",text:"🧮 คิดคำนวณสารน้ำ CRRT",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true}]}]},body:{type:"box",layout:"vertical",paddingAll:"14px",backgroundColor:"#FFF8F2",spacing:"sm",contents:[{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFF3E0",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#E65100",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"🎯 Dose Formula",weight:"bold",size:"sm",color:"#BF360C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Total Effluent = Qpre+Qpost+Qdialysate+Quf (net fluid removal)",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"BW60kg: 30ml/kg/hr=1,800ml/hr | Delivered ≥80% ของ Prescribed",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#E65100",size:"sm",flex:0,gravity:"top"},{type:"text",text:"ตัวอย่าง: Pre1,100+Dialysate500+UF200=1,800ml/hr Effluent",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#E3F2FD",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#1565C0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"💧 Fluid Balance",weight:"bold",size:"sm",color:"#0D47A1",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"IN: IV Fluid+ยา Drip+EN/TPN+NSS flush",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"OUT: Urine+Drain+Effluent CRRT | Net=IN−OUT",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#1565C0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Patient Fluid Removal = ค่าที่ตั้งบนเครื่องเพื่อดึงน้ำส่วนเกิน",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#EDE7F6",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#4527A0",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"🔬 Regional Citrate (RCA)",weight:"bold",size:"sm",color:"#4A148C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Prismocitrate Pre-filter | iCa Circuit target <0.33 mmol/L",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"10% Ca Gluconate Systemic: เริ่ม 10ml/hr | Target iCa systemic 0.9-1.2",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Monitor: Circuit iCa q2h แรก แล้ว q6-8h | Systemic q6-8h",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Ca/iCa ratio >2.5 = Citrate Accumulation → ลด BFR เพิ่ม DFR",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#4527A0",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Contraindication: Liver fail(AST/ALT>1,000), Lactic acidosis",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]},{type:"separator",margin:"md",color:"#E8ECF4"},{type:"box",layout:"horizontal",margin:"sm",backgroundColor:"#FFEBEE",paddingAll:"10px",cornerRadius:"10px",spacing:"sm",contents:[{type:"box",layout:"vertical",width:"5px",backgroundColor:"#C62828",cornerRadius:"4px",contents:[]},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"⚠️ Heparin (ถ้า Citrate ข้อห้าม)",weight:"bold",size:"sm",color:"#B71C1C",wrap:true}]}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"Bolus 1,000U → Drip 500U/hr → ปรับ aPTT | ระวัง HITT",size:"sm",color:"#2D2D2D",weight:"regular",wrap:true,flex:1}]},{type:"box",layout:"horizontal",margin:"xs",spacing:"sm",paddingStart:"12px",contents:[{type:"text",text:"·",color:"#C62828",size:"sm",flex:0,gravity:"top"},{type:"text",text:"ห้ามใช้ถ้า: Active bleeding, Plt<50K, INR>2, Post-op<48h",size:"sm",color:"#B71C1C",weight:"bold",wrap:true,flex:1}]}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"message",label:"📚 กลับ Knowledge",text:"crrt_knowledge"},style:"primary",color:"#1565C0",height:"sm",adjustMode:"shrink-to-fit"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}
...
loadDB().then(()=>{
  ...
  app.listen(PORT,()=>console.log(`CRRT Bot v23.0 :${PORT}`));
});
