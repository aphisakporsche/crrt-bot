...
async function handleEvent(event) {
  ...
  if(text==="show_cleanup"){await client.replyMessage(replyToken,{type:"flex",altText:"📦 วิธีเก็บเครื่อง CRRT",contents:{type:"bubble",body:{type:"box",layout:"vertical",paddingAll:"16px",spacing:"md",backgroundColor:"#F1F8E9",contents:[{type:"box",layout:"horizontal",backgroundColor:"#2E7D32",paddingAll:"12px",cornerRadius:"10px",spacing:"sm",contents:[{type:"text",text:"📦",size:"xl",flex:0,gravity:"center"},{type:"box",layout:"vertical",flex:1,margin:"sm",justifyContent:"center",contents:[{type:"text",text:"วิธีเก็บเครื่อง CRRT",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true},{type:"text",text:"RA5IC · RAMATHIBODI",color:"#A5D6A7",size:"xxs"}]}]},{type:"text",text:"กดปุ่มด้านล่างเพื่อดูวิธีเก็บเครื่องได้เลยครับ 👇",size:"sm",color:"#555",wrap:true}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"uri",label:"▶️ ดูวิธีเก็บเครื่อง",uri:"https://drive.google.com/file/d/1O8eu49l3ppjgu9ULMteWaOZkTwrgvoku/view?usp=sharing"},style:"primary",color:"#2E7D32",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"primary",color:"#F9A825",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}
