...
async function handleEvent(event) {
  ...
  if(text==="show_cleanup"){await client.replyMessage(replyToken,{type:"flex",altText:"📦 วิธีเก็บเครื่อง CRRT",contents:{type:"bubble",hero:{type:"image",url:"https://drive.google.com/uc?export=view&id=1O8eu49l3ppjgu9ULMteWaOZkTwrgvoku",size:"full",aspectMode:"fit",aspectRatio:"20:13"},body:{type:"box",layout:"vertical",paddingAll:"12px",spacing:"sm",contents:[{type:"text",text:"📦 วิธีเก็บเครื่อง CRRT",weight:"bold",size:"md",color:"#1B5E20",wrap:true},{type:"text",text:"กดปุ่มด้านล่างเพื่อดูวิธีเก็บเครื่องครับ 👇",size:"sm",color:"#555",wrap:true,margin:"xs"}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"uri",label:"▶️ ดูวิธีเก็บเครื่อง",uri:"https://drive.google.com/file/d/1O8eu49l3ppjgu9ULMteWaOZkTwrgvoku/view?usp=sharing"},style:"primary",color:"#2E7D32",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"primary",color:"#F9A825",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}
