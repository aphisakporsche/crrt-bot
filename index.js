...
async function handleEvent(event) {
  ...
  if(text==="crrt_billing"){await client.replyMessage(replyToken,{type:"flex",altText:"💳 สิทธิ์การรักษา CRRT",contents:{type:"bubble",body:{type:"box",layout:"vertical",paddingAll:"16px",spacing:"md",contents:[{type:"box",layout:"horizontal",backgroundColor:"#1565C0",paddingAll:"12px",cornerRadius:"10px",spacing:"sm",contents:[{type:"text",text:"💳",size:"xl",flex:0,gravity:"center"},{type:"box",layout:"vertical",flex:1,margin:"sm",contents:[{type:"text",text:"สิทธิ์การรักษา CRRT",color:"#FFFFFF",size:"sm",weight:"bold",wrap:true},{type:"text",text:"RA5IC · RAMATHIBODI",color:"#BBCFFF",size:"xxs"}]}]},{type:"separator",margin:"md",color:"#BBDEFB"},{type:"text",text:"กดปุ่มด้านล่างเพื่อดูตารางสิทธิ์การรักษา CRRT ครับ 👇",size:"sm",color:"#555",wrap:true},{type:"text",text:"⚠️ อนุมัติเฉพาะ AKI | Oxiris เบิกไม่ได้",size:"xs",color:"#B71C1C",weight:"bold",wrap:true}]},footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#F8F9FC",contents:[{type:"button",action:{type:"uri",label:"🖼️ ดูตารางสิทธิ์",uri:"https://drive.google.com/file/d/1dU5auR9YK4VeOIsdwsV5W_iNhU8NsJAO/view?usp=sharing"},style:"primary",color:"#1565C0",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"},{type:"button",action:{type:"message",label:"📚 กลับ Knowledge",text:"crrt_knowledge"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"},{type:"button",action:{type:"message",label:"🏠 Main Menu",text:"main_menu"},style:"secondary",height:"sm",adjustMode:"shrink-to-fit",margin:"xs"}]}}});return;}
