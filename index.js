...
function alarmFlex(alarm, subRows, trigger) {
  ...
  for (let n=1;n<=6;n++) {
    ...
    const _lblMap={"✅ ค่า TMP ลดลง / RUN เครื่องต่อได้":"✅ TMP ลดลง Run ต่อ","✅ ค่า TMP ลดลง / RUN เครื่องต่อ":"✅ TMP ลดลง Run ต่อ","🚨 แก้ไขแล้ว TMP ไม่ลด (> 250 mmHg) ➡️ เตรียม [Return Blood]":"🚨 TMP ไม่ลด ไปต่อ","✅ แก้ไขสำเร็จ / รันต่อได้":"✅ แก้ไขสำเร็จ รันต่อ","✅ แก้ไขสำเร็จ / Run ต่อได้  ":"✅ แก้ไขสำเร็จ รันต่อ","✅ แก้ไขสำเร็จ / Run ต่อได้":"✅ แก้ไขสำเร็จ รันต่อ","✅ แก้ไขสำเร็จ Run เครื่องต่อได้":"✅ แก้ไขสำเร็จ รัน","🔄 ย้ายจุดต่อแล้วยัง Alarm":"🔄 ย้ายแล้วยัง Alarm","🚨 แรงดันสูงวิกฤต (Stop เครื่อง) ➡️ พิจารณา [Return Blood]":"🚨 แรงดันสูงวิกฤต","✅ ไฟเข้าแล้ว / รันต่อได้":"✅ ไฟเข้าแล้ว รันต่อ","🚨 แก้ไขไม่ได้แล้ว แต่ครื่องยังทำงาน  ➡️ เตรียม [Return Blood] ให้เร็วที่สุด":"🚨 แก้ไม่ได้คืนเลือด","🚨 เครื่องดับไปแล้ว (คืนเลือดไม่ได้)":"🚨 เครื่องดับไปแล้ว","✅ แก้ไขสำเร็จ สรุปเป็น False Alarm  ":"✅ False Alarm รัน","✅ แก้ไขสำเร็จ สรุปเป็น False Alarm":"✅ False Alarm รัน","🚨 สายปนเปื้อน (ทิ้ง Set / เปลี่ยนใหม่)":"🚨 สายปนเปื้อน","✅ แรงดันนิ่งแล้ว / รันต่อได้":"✅ แรงดันนิ่ง รัน","🚨 จอยังค้าง (เริ่มคืนเลือด Manual)":"🚨 จอค้าง คืนเลือด","✅ เปลี่ยนเสร็จ / รันต่อได้  ":"✅ เปลี่ยนเสร็จ รัน","✅ เปลี่ยนเสร็จ / รันต่อได้":"✅ เปลี่ยนเสร็จ รัน","✅ ล็อกเข้าแล้ว / รันต่อได้":"✅ ล็อกเข้าแล้ว รัน","🔄 เปลี่ยนแล้วยัง Alarm (Check Scale)  ":"🔄 ยัง Alarm Scale","🔄 เปลี่ยนแล้วยัง Alarm (Check Scale)":"🔄 ยัง Alarm Scale","🔄 ยัง Alarm ซ้ำ (Check Floor)":"🔄 ยัง Alarm Floor","🔄 ดันแล้วไม่เข้าล็อก (Scale Stuck)":"🔄 Scale Stuck","🚨 ก้านหัก / ล็อกไม่ได้➡️ [Return Blood] ":"🚨 ก้านหัก คืนเลือด","🚨 ก้านหัก / ล็อกไม่ได้➡️ [Return Blood]":"🚨 ก้านหัก คืนเลือด","🔄 ใส่แล้วยัง Alarm (Syringe not loaded)  ":"🔄 ยัง Alarm Syringe","🔄 ใส่แล้วยัง Alarm (Syringe not loaded)":"🔄 ยัง Alarm Syringe","✅ จอกลับมาแล้ว / รันต่อได้":"✅ จอกลับมา รัน","🔄 รีสตาร์ทแล้วยัง Fail (System Error) ➡️ เปลี่ยนเครื่องใหม่ทันที":"🔄 System Error","✅ เปิด Clamp แล้ว / รันต่อได้":"✅ เปิด Clamp รัน","🔄 เช็คสายแล้วยัง Alarm (Pump Error)➡️ แจ้ง Hotline   ":"🔄 Pump Error","🔄 เช็คสายแล้วยัง Alarm (Pump Error)➡️ แจ้ง Hotline":"🔄 Pump Error","🔄 ยังแกว่งซ้ำ ➡️ ลองสลับสายแดง-น้ำเงิน (Swap Lines)  ":"🔄 Swap Lines","🔄 ยังแกว่งซ้ำ ➡️ ลองสลับสายแดง-น้ำเงิน (Swap Lines) ":"🔄 Swap Lines","🚨 แกว่งจน Access Extremely Negative":"🚨 Access Neg วิกฤต","✅ Test ผ่านแล้ว / เริ่ม Prime ต่อ":"✅ Test ผ่าน Prime","✅ สายหลุดแต่ยังสะอาด (ต่อกลับ)":"✅ สายสะอาด ต่อกลับ","🚨 สายปนเปื้อน / เปลี่ยน Set ทันที":"🚨 สายปนเปื้อน"};
...
function mainMenu(){
  return {type:"flex",altText:"🏥 CRRT Bot RA5IC",contents:{type:"bubble",
    ...
    footer:{type:"box",layout:"vertical",paddingAll:"10px",spacing:"xs",backgroundColor:"#FAFAFA",contents:[
      ...
      {type:"box",layout:"horizontal",spacing:"xs",margin:"xs",contents:[
        {type:"button",action:{type:"message",label:"❤️ Hypotension",text:"hypotension"},style:"primary",color:"#B71C1C",height:"sm",adjustMode:"shrink-to-fit",flex:1},
